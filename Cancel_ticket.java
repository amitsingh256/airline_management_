...
public class Cancel_ticket extends JFrame implements ActionListener{
    ...
    JButton fetchButton, flight;
     ...
     public Cancel_ticket() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Airline_management/icons/cancel.jpeg"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == fetchButton) {
            ...
            try {
                ...
                c.stmt.executeUpdate("delete from reservation where PNR = '"+pnr+"'");
